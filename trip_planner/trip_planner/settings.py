...
SECRET_KEY = "django-insecure-k9uwu1=163%0gff0qq@(-y%2s+8!y-$1*1n(6lic5xc&1!imgm"
...
# We'll use pymongo directly in our application code
# No database router configuration needed
MONGODB_SETTINGS = {
    'HOST': 'localhost',
    'PORT': 27017,
    'DB_NAME': 'waybot_db',
